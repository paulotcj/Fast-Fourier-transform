...
def FullFourierTransformWithGraph():
    ...
    timeSpan = np.linspace(0, 0.875*5, 8*5*32) #from 0 seconds, to 4.375 seconds, with 1280 sampling points
    ...
    # Fourier Transform - In this case Discrete Fourier Transform
    ...
    #-----
    # Show a graph representing the amplitude over time (time-domain signal)
    plt.xlabel("Time [s]")
